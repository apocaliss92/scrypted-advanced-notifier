            ...
            if (triggered) {
                ...
                for (const rule of rules) {
                    ...
                    this.plugin.notifyDetectionEvent({
                        ...
                        eventSource: NotifyDetectionSource.Sensor,
                        eventType: this.supportedSensorType,
                        triggerTime,
                        matchRule: {
                            rule,
