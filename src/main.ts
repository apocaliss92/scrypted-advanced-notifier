    ...
    async onRequest(request: HttpRequest, response: HttpResponse): Promise<void> {
        ...
        try {
            ...
            if (webhook === haAction) {
                ...
                const message = `Snoozing notifications ${decodedSnoozeId} for device ${device?.name} for ${decodedSnoozeTime} minutes`;
                logger.log(message);
